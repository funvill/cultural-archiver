...
describe('DatabaseRecreator', () => {
  ...
  describe('Database Operations', () => {
    ...
    it('should get existing tables successfully', async () => {
      const mockTablesResponse = {
        ...
        result: [
          {
            results: [{ name: 'artwork' }, { name: 'logbook' }, { name: 'users' }],
          },
        ],
      };
  ...
  describe('Schema Processing', () => {
    ...
    it('should summarize statements correctly', () => {
      const longStatement =
        'CREATE TABLE users (id TEXT PRIMARY KEY, name TEXT NOT NULL, email TEXT UNIQUE, created_at TEXT DEFAULT datetime("now"))';
  ...
  describe('Sample Data Generation', () => {
    it('should generate default sample data with correct structure', () => {
      const generateDefaultSampleData = (recreator as any).generateDefaultSampleData.bind(
        recreator
      );
  ...
  describe('Schema File Operations', () => {
    ...
    it('should handle file read errors', async () => {
      ...
      await expect(loadSchemaFile()).rejects.toThrow(
        'Failed to load schema file: Error: File not found'
      );
    });
  });
