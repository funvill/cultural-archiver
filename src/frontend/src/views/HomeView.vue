    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600">
            Every submission from our community helps build a more complete picture of public art worldwide.
          </p>
        </div>
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600">
            All submissions are reviewed by our moderation team to ensure accuracy and appropriate content.
          </p>
        </div>
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600">
            Designed for on-the-go discovery and documentation with offline-capable mobile interfaces.
          </p>
        </div>
      ...
      <div class="bg-gray-50 rounded-lg p-8 mb-16">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="text-center">
            ...
            <p class="text-gray-600">
              Find public art on our interactive map or discover new pieces while exploring your community.
            </p>
          </div>
          <div class="text-center">
            <div class="w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
            ...
            <p class="text-gray-600">
              Upload photos and details through our 60-second submission process, including location and context.
            </p>
          </div>
          <div class="text-center">
            <div class="w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
            ...
            <p class="text-gray-600">
              Your contributions become part of the permanent cultural record, accessible to everyone.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-blue-50 rounded-lg p-8 text-center">
        ...
        <p class="text-gray-700 mb-6 max-w-2xl mx-auto">
          ...
          there's a place for you in our community. Join us in building the world's most comprehensive 
          cultural archive.
        </p>
