    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="text-center mb-16">
        ...
        <p class="text-lg text-gray-700 max-w-2xl mx-auto">
          ...
          Through community participation, we're building the world's most comprehensive map of public artworks, 
          making culture accessible to everyone while preserving it for future generations.
        </p>
      </div>
      ...
      <div class="mb-16">
        ...
        <div class="space-y-6">
          ...
          <div id="location-access-faq" class="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            <h3 class="text-xl font-semibold text-gray-900 mb-3">Why do you need location access?</h3>
            <div class="text-gray-700 space-y-3">
              <p>
                Location access helps us provide you with the best possible experience:
              </p>
              <ul class="list-disc list-inside space-y-2 ml-4">
                <li><strong>Find nearby artworks:</strong> We show you public art in your immediate area</li>
                <li><strong>Accurate submissions:</strong> When you submit new artwork, we can automatically capture its precise location</li>
                <li><strong>Improve map experience:</strong> We can center the map on your location for easier navigation</li>
                <li><strong>Better recommendations:</strong> We can suggest artworks to visit based on your current location</li>
              </ul>
              <p class="text-sm text-yellow-800 bg-yellow-100 rounded p-3">
                <strong>Privacy note:</strong> Your location is only used locally in your browser to enhance your experience. 
          ...
          <div class="bg-white border border-gray-200 rounded-lg p-6">
            <h3 class="text-xl font-semibold text-gray-900 mb-3">What types of artwork can I submit?</h3>
            <p class="text-gray-700">
              You can submit any publicly accessible artwork including murals, sculptures, monuments, street art, 
              mosaics, installations, and other forms of public art. The artwork should be visible and accessible 
              to the general public.
            </p>
          </div>

          <div class="bg-white border border-gray-200 rounded-lg p-6">
            <h3 class="text-xl font-semibold text-gray-900 mb-3">Do I need an account to use Cultural Archiver?</h3>
            <p class="text-gray-700">
              No! You can submit artwork and explore the map without creating an account. However, creating an account 
              allows you to claim your anonymous submissions, sync your data across devices, and helps us prevent spam.
            </p>
          </div>

          <div class="bg-white border border-gray-200 rounded-lg p-6">
            <h3 class="text-xl font-semibold text-gray-900 mb-3">How do you ensure data quality?</h3>
            <p class="text-gray-700">
              All submissions go through a moderation process where trained reviewers verify the information and photos. 
              We also use community reporting to maintain data accuracy and remove inappropriate content.
            </p>
          </div>

          <div class="bg-white border border-gray-200 rounded-lg p-6">
            <h3 class="text-xl font-semibold text-gray-900 mb-3">Can I edit artwork information?</h3>
            <p class="text-gray-700">
              Currently, artwork information is managed through our moderation system. If you notice incorrect information, 
              you can submit a new entry with the correct details, and our moderators will review and update the record.
            </p>
          </div>

          <div class="bg-white border border-gray-200 rounded-lg p-6">
            <h3 class="text-xl font-semibold text-gray-900 mb-3">Is the data available for research or other projects?</h3>
            <p class="text-gray-700">
              Yes! We believe in open cultural data. Our database will be available for public download under a 
              Creative Commons license, making it valuable for researchers, city planners, and other cultural initiatives.
            </p>
          </div>

          <div class="bg-white border border-gray-200 rounded-lg p-6">
            <h3 class="text-xl font-semibold text-gray-900 mb-3">How can I report inappropriate content?</h3>
            <p class="text-gray-700">
              If you encounter inappropriate content, please contact our moderation team. We take content quality seriously 
              and will promptly review and address any reported issues.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        <div class="text-center">
          ...
          <p class="text-gray-600">
            Explore public artworks on an interactive map with clustering, 
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600">
            Submit new artworks with photos, location data, and detailed descriptions 
            using our streamlined submission process.
          </p>
        </div>
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600">
            Built by the community, for the community. Every submission helps preserve 
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600">
            All submissions are reviewed by moderators to ensure accuracy 
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600">
            All artwork data will be made freely available under open licenses 
            for research, education, and cultural initiatives.
          </p>
        </div>
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600">
            ...
            and offline capabilities for field documentation.
          </p>
        </div>
      </div>
      ...
      <div class="mb-16">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="text-center">
            ...
            <p class="text-gray-600">
              Explore the interactive map to discover public artworks in your area or around the world.
            </p>
          </div>
          <div class="text-center">
            ...
            <p class="text-gray-600">
              Found new artwork? Submit photos, location, and details to add it to our growing database.
            </p>
          </div>
          <div class="text-center">
            ...
            <p class="text-gray-600">
              Help others discover cultural treasures by contributing to our community-driven archive.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="text-center bg-gray-50 rounded-lg p-8">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="mailto:support@culturalarchiver.org"
