...
<template>
  <div ref="containerRef" class="relative w-full">
    ...
    <div class="relative">
      ...
      <!-- Clear Button -->
      <div v-if="showClear" class="absolute inset-y-0 right-0 flex items-center pr-3">
        <button
          type="button"
          class="p-1 text-gray-400 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded-full"
          :disabled="disabled || false"
          @click="clearInput"
    ...
    >
      <ul class="py-1">
        <li
          ...
          :id="`suggestion-${index}`"
          class="px-4 py-2 cursor-pointer text-sm hover:bg-gray-50 focus:bg-gray-50 flex items-center space-x-2"
          :class="{
