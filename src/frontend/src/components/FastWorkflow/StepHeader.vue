  ...
  >
    <div class="flex items-center space-x-3">
      <div 
        ...
        :class="completed ? 'bg-green-500 text-white' : active ? 'bg-blue-500 text-white' : 'bg-gray-300 text-gray-600 dark:bg-gray-600 dark:text-gray-300'"
      >
      ...
      <h3 
        ...
        :class="completed ? 'text-green-700 dark:text-green-300' : active ? 'text-blue-700 dark:text-blue-300' : 'text-gray-900 dark:text-white'"
      >
        {{ title }}
      </h3>
