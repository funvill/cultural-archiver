...
<template>
  <div v-if="props.orientation === 'horizontal'" class="flex items-center justify-between h-16 px-4">
    ...
    >
      <Bars3Icon class="w-6 h-6 theme-text-muted" aria-hidden="true" />
    </button>
    ...
    <div class="relative">
      <button
        ...
        class="fab flex items-center justify-center w-14 h-14 theme-primary theme-on-primary rounded-full shadow-lg hover:theme-primary-hover hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
    ...
    <div class="flex items-center space-x-2">
      ...
      <button
        ...
        class="relative flex items-center justify-center w-12 h-12 rounded-full theme-hover-background focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
        aria-label="View notifications"
      >
        <BellIcon class="w-6 h-6 theme-text-muted" aria-hidden="true" />
        <span
      ...
      <button
        ...
        title="Map"
      >
        <MapIcon class="w-6 h-6 theme-text-muted" aria-hidden="true" />
      </button>
  ...
  <div v-else class="flex flex-col items-center px-3 py-4 space-y-3">
    ...
    >
      <UserIcon class="w-6 h-6 theme-text-muted" aria-hidden="true" />
    </button>

    <button
      v-else
      @click="handleLoginClick"
      class="flex items-center justify-center w-12 h-12 rounded-full hover:theme-nav-link-hover hover:theme-nav-link focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
      title="Login"
    >
      <ArrowRightOnRectangleIcon class="w-6 h-6 theme-text-muted" aria-hidden="true" />
    </button>
