...
function getFieldLabel(fieldName: string): string {
  return (
    fieldDisplayInfo[fieldName]?.label ||
  ...
  <div class="artwork-edit-diffs">
    ...
    <div class="space-y-4">
      ...
      >
        ...
        <!-- Field Content -->
        <div
          v-for="diff in groupedDiffs[fieldName]"
          :key="`${fieldName}-${diff.old_value}-${diff.new_value}`"
        >
          ...
          <div v-else class="space-y-3">
            <div
              v-if="diff.old_value !== undefined && diff.new_value !== undefined"
