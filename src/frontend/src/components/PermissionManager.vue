...
<template>
  <div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div>
        <h2 class="text-lg font-medium text-gray-900 dark:text-white">User Permissions</h2>
    ...
    >
            ...
            <div class="flex-1">
              ...
              <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                <span v-for="(permission, index) in user.permissions" :key="permission.permission">
                  {{ permission.permission }} granted {{ formatDate(permission.granted_at)
      ...
      <!-- Pagination -->
      <div
        v-if="permissions.total > permissions.users.length"
    ...
    >
      ...
      >
        <div class="mt-3">
          <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Grant Permission</h3>
    ...
    >
      ...
      >
        <div class="mt-3">
          <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Revoke Permission</h3>
