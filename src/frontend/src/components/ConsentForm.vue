...
const isFormValid = computed(() => {
  return (
    formData.value.ageVerification &&
...
<template>
  <div class="consent-form bg-white rounded-lg shadow-lg p-6 max-w-2xl mx-auto">
    <!-- Header -->
    <div class="mb-6">
      <h2 class="text-2xl font-bold text-gray-900 mb-2">Consent for Photo Submission</h2>
      <p class="text-gray-600">
        Before submitting photos to the Cultural Archiver, we need your consent for the legal use
    ...
    <form @submit.prevent="handleSubmit" class="space-y-6">
        ...
        <div class="flex items-start space-x-3">
          ...
          <div class="flex-1">
            ...
            <p class="text-sm text-gray-600 mt-1">
              I confirm that I am 18 years of age or older and legally able to provide consent for
              photo submissions.
            </p>
            <p
              v-if="errors.ageVerification"
        ...
        <div class="flex items-start space-x-3">
          ...
          <div class="flex-1">
            ...
            <p class="text-sm text-gray-600 mt-1">
              ...
              >
                CC0 1.0 Universal </a
              >. This means anyone can use these photos for any purpose without attribution
              requirements.
            </p>
      ...
      <div class="consent-section">
        <div class="flex items-start space-x-3">
          ...
          <div class="flex-1">
            ...
            <p class="text-sm text-gray-600 mt-1">
              I understand that my submissions will become part of a public cultural archive and may
              be used for educational, research, and cultural preservation purposes.
            </p>
      ...
      <div class="consent-section">
        <div class="flex items-start space-x-3">
          ...
          <div class="flex-1">
            ...
            <p class="text-sm text-gray-600 mt-1">
              I understand Canada's Freedom of Panorama laws and confirm that my photos are taken
              from publicly accessible locations. Learn more about
              <a
                ...
                class="text-blue-600 hover:text-blue-800 underline"
              >
                Canadian Freedom of Panorama </a
              >.
            </p>
      ...
      <div class="bg-gray-50 rounded-lg p-4">
        <h3 class="text-sm font-medium text-gray-900 mb-2">Consent Information</h3>
        <div class="text-sm text-gray-600 space-y-1">
          <p>Consent Version: {{ CONSENT_VERSION }}</p>
          <p>Your consent will be recorded with a timestamp for legal compliance.</p>
          <p>
            You can withdraw consent at any time by contacting us, though previously submitted
            photos under CC0 cannot be recalled from the public domain.
          </p>
        </div>
      </div>
      ...
      <div class="flex justify-end space-x-4">
        ...
        >
          ...
          <span v-else> Provide Consent </span>
        </button>
      </div>
    </form>
