<template>
  <div class="profile-name-editor">
    ...
    <div v-if="!isEditing && currentProfileName" class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
      <div>
    ...
    <!-- No Profile Name Set -->
    <div v-else-if="!isEditing && !currentProfileName" class="p-4 bg-blue-50 rounded-lg border border-blue-200">
    ...
    <div v-if="isEditing" class="space-y-4">
      <div>
        ...
        <div class="relative">
          <input
            ...
            :class="{
              ...
              'border-green-300 focus:ring-green-500 focus:border-green-500': isAvailable && profileNameInput.length >= 3
            }"
            @input="onInput"
          ...
          <div v-else-if="profileNameInput.length >= 3" class="absolute right-3 top-2.5">
            <svg v-if="isAvailable" class="h-5 w-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div v-else-if="availabilityMessage" class="mt-2 text-sm" :class="{
...
const canSave = computed(() => {
  return profileNameInput.value.length >= 3 && 
...
watch(() => props.currentProfileName, (newValue) => {
