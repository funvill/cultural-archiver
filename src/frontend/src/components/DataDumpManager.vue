    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
      <div class="px-4 py-5 sm:p-6">
        ...
        <div v-else class="overflow-hidden">
          ...
          <!-- Summary -->
          <div v-if="dataDumps?.total" class="bg-gray-50 dark:bg-gray-700 px-6 py-3 border-t border-gray-200 dark:border-gray-600">
            <div class="text-sm text-gray-600 dark:text-gray-400">
              Total: {{ dataDumps.total }} data dump{{ dataDumps.total !== 1 ? 's' : '' }}
              • Last updated: {{ formatDate(dataDumps.retrieved_at) }}
            </div>
          </div>
        </div>
      </div>
