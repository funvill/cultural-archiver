    ...
    artists: [
      {
        ...
        description: 'Renowned Canadian artist and writer, known for her paintings of Indigenous peoples of the Pacific Northwest Coast.',
...
vi.mock('../lib/photos', () => ({
  processAndUploadPhotos: vi.fn(() => Promise.resolve([
    { originalUrl: 'https://r2.example.com/digital-orca-1.jpg', thumbnailUrl: 'https://r2.example.com/thumb-1.jpg' },
    { originalUrl: 'https://r2.example.com/digital-orca-2.jpg', thumbnailUrl: 'https://r2.example.com/thumb-2.jpg' }
  ])),
}));
