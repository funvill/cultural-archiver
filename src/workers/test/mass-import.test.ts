...
describe('Mass Import System', () => {
  ...
  describe('Data Processing', () => {
    const mockData = [
      ...
      },
      {
        ...
        geo_point_2d: { lat: 49.285, lon: -123.115 },
        type: 'Mural',
        material: 'Paint',
      },
    ];
  ...
  describe('Tag Mapping and Validation', () => {
    ...
    it('should handle template-based tag mappings', async () => {
      ...
      const processedRecord = results.successful_records[0];
      expect(processedRecord.applied_tags.data_source_url).toBe(
        'https://example.com/artwork/test-003'
      );
    });
  });
  ...
  describe('Constants and Defaults', () => {
    it('should provide correct default constants', () => {
      ...
      expect(MASS_IMPORT_CONSTANTS.MASS_IMPORT_USER_UUID).toBe(
        'a0000000-1000-4000-8000-000000000002'
      );
    });
    ...
    it('should provide correct similarity thresholds', () => {
      ...
      expect(MASS_IMPORT_CONSTANTS.DUPLICATE_THRESHOLDS.MODERATE_SIMILARITY).toBe(0.7);
