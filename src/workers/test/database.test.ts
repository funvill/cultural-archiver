...
describe('Database Service', (): void => {
  ...
  // Creator-related tests - legacy functions removed, keeping getCreatorsForArtwork
  ...
  // Legacy getArtworksForCreator test removed - function used non-existent artwork_creators table
});
