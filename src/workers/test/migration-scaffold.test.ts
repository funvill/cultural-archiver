...
describe('Migration Scaffolding', () => {
    ...
    describe('sanitizeMigrationName', () => {
        ...
        it('should handle special characters', () => {
            expect(sanitizeMigrationName('Add User@Email & Permissions!')).toBe('add_user_email_permissions');
        ...
        it('should truncate long names', () => {
            const longName = 'this_is_a_very_long_migration_name_that_should_be_truncated_to_fifty_characters_maximum';
