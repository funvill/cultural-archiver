...
describe('Export Integration Tests', () => {
  ...
  describe('Bulk Export', () => {
    ...
    it('should export all artworks when no filters provided', async () => {
      mockDB.prepare().all.mockResolvedValue({ results: mockArtworks });
    ...
    it('should export artworks by specific IDs', async () => {
      mockDB.prepare().all.mockResolvedValue({ results: [mockArtworks[0]] });
  ...
  describe('Export Statistics', () => {
    it('should return export statistics', async () => {
      ...
      mockDB.prepare()
        .first.mockResolvedValueOnce(mockCountResult)
        .all.mockResolvedValueOnce(mockSampleResult);
